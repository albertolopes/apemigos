...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    try {
        ...
        const item: NewsContentResponse = await newsService.getNewsContentBySlug(slug);
        ...
        const imageUrl = item.noticia.image || 'https://apemigosbrasil.org.br/images/logo.png';
